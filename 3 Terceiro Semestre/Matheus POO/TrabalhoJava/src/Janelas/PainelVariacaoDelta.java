...
class PainelVariacaoDelta extends JPanel implements ActionListener{
	...
	PainelVariacaoDelta() {
		...
		valorA = new JLabel("Valor inicial:");
		valorA.setForeground(Color.RED);
		
		valorB = new JLabel("Desconto final:");
		valorB.setForeground(Color.BLUE);
		
		resultado = new JLabel("Diferença (%):");
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			double resultado = Formulas.variacaoDelta(valorA, valorB);
