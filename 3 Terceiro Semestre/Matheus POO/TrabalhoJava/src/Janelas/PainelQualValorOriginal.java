...
class PainelQualValorOriginal extends JPanel implements ActionListener{
	private JLabel valorA, valorB, resultado;
	private JTextField inputA, inputB, outResultado;
	private JButton calcularButton;
	
	PainelQualValorOriginal() {
		...
		valorA = new JLabel("Valor final (R$):");
		valorA.setForeground(Color.RED);
		
		valorB = new JLabel("Desconto (%):");
		valorB.setForeground(Color.BLUE);
		
		resultado = new JLabel("Valor inicial (R$):");
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			double resultado = Formulas.valorOriginal(valorA, valorB);
