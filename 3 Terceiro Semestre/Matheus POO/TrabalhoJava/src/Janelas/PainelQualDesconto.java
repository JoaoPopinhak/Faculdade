...
class PainelQualDesconto extends JPanel implements ActionListener{
	...
	PainelQualDesconto() {
		...
		valorA = new JLabel("Valor original (R$):");
		valorA.setForeground(Color.RED);
		
		valorB = new JLabel("Valor c/desconto (R$):");
		valorB.setForeground(Color.BLUE);
		
		resultado = new JLabel("Desconto (%):");
	...
	public void actionPerformed(ActionEvent e) {
		...
		double resultado = Formulas.qualDesconto(valorA, valorB);
